...
from simple_html_to_text_classifier import SimpleHTMLToTextClassifier
...
if __name__ == "__main__":
    ...
    if args.check:
        print('Check "' + SimpleHTMLToTextClassifier.__name__ + '" instance creation..')
        model = SimpleHTMLToTextClassifier(**kwargs)

    app = init_app(
        model_class=SimpleHTMLToTextClassifier,
